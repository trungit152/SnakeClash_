...
namespace Utilities.Components
{
    ...
    public class CustomToggleTab : Toggle
    {
        ...
        private void Refresh()
        {
            ...
            {
                int lengthF2 = contentsInActive.Count;
                for (int k = 0; k < lengthF2; k++)
                {
                    var item = contentsInActive[k];
            ...
            {
                int lengthF2 = contentsInDeactive.Count;
                for (int k = 0; k < lengthF2; k++)
                {
                    var item = contentsInDeactive[k];
            ...
            if (enableTextColorSwitch)
            {
                ...
                {
                    int lengthF2 = additionalLabels.Count;
                    for (int k = 0; k < lengthF2; k++)
                    {
                        var label = additionalLabels[k];
