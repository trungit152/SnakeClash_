...
using System.IO;
using System.Linq;
#if UNITY_ANDROID && UNITY_NOTIFICATION
using Unity.Notifications.Android;
using Utilities.Service.Notification.Android;
#elif UNITY_IOS && UNITY_NOTIFICATION
using Utilities.Service.Notification.iOS;
#endif
using UnityEngine;
...
namespace Utilities.Service.Notification
{
    ...
    public class GameNotificationsManager : MonoBehaviour
    {
        ...
        private static GameNotificationsManager mInstance;
        ...
        public enum OperatingMode
        {
            ...
            /// </para>
            /// <para>
            /// If badge numbers are not set, will automatically increment them. This will only happen if NO badge numbers for pending notifications are ever set.
            /// </para>
            /// </summary>
            Queue = 0x01,
        ...
        public IGameNotification CreateNotification()
        {
            if (!Initialized)
            {
                Debug.LogError("Must call Initialize() first.");
                return null;
            }
